...
export const metadata: Metadata = {
  ...
  description: "Practical, no-hype guides and insights for small teams — WordPress, Hosting, AI Tools, Workflows and more.",
  openGraph: {
    title: "Editorial | Practical No-Hype Guides for Small Teams",
    description: "Practical, no-hype guides and insights for small teams — WordPress, Hosting, AI Tools, Workflows and more.",
...
export default function EditorialPillarPage() {
  ...
  const pillars = [
    { title: "WordPress Guides", href: "/wordpress", posts: wordpressPosts },
    { title: "Hosting Guides", href: "/hosting", posts: hostingPosts },
    { title: "AI Tools & Workflows", href: "/ai-tools", posts: aiPosts },
    { title: "Workflows", href: "/workflows", posts: workflowPosts },
  ];
    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-8 md:px-6 md:py-12">
      ...
      <div className="grid gap-10 lg:grid-cols-12">
        <main className="lg:col-span-8">
            ...
            {pillars.map((pillar) => (
              ...
              >
                ...
                <p className="mb-6 text-sm text-[var(--text-secondary)]">
                  Expertly curated {pillar.title.toLowerCase()} specifically for small, efficient teams.
                </p>
              ...
              <section key={`section-${pillar.href}`} className="scroll-mt-24">
                ...
                <div className="grid gap-4">
                  {pillar.posts.length > 0 ? (
                    ...
                    <p className="text-sm text-[var(--text-secondary)] italic">More editorial insights coming soon.</p>
                  )}
                </div>
              </section>
            ))}
          ...
          <section className="mt-24 p-8 rounded-3xl border border-[var(--border)] bg-[var(--surface-2)]">
            <h2 className="text-2xl font-bold mb-6 text-[var(--text-primary)]">Our Editorial Commitment</h2>
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                <h3 className="font-bold text-sm uppercase tracking-widest text-amber-600 mb-2">Rigorous Testing</h3>
                <p className="text-sm text-[var(--text-secondary)]">
                  We never recommend a tool or workflow we haven't personally tested in live production.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-sm uppercase tracking-widest text-amber-600 mb-2">AI Transparency</h3>
                <p className="text-sm text-[var(--text-secondary)]">
